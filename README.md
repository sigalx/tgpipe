...
```bash
wget https://github.com/sigalx/tgpipe/releases/download/v1.0.2/tgpipe_1.0.2-1_all.deb
sudo dpkg -i tgpipe_1.0.2-1_all.deb
```
...
# copy your .deb here
sudo cp /path/to/tgpipe_1.0.2-1_all.deb .
